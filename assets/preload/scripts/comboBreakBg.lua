...
function ComboBreak(dir, rating)
	setProperty('thingToDisplay' .. dir .. '.alpha', 0.425)
	
	if rating == 'miss' then
		setProperty('thingToDisplay' .. dir .. '.color', 0xEA9105)
	elseif rating == 'shit' then
		setProperty('thingToDisplay' .. dir .. '.color', 0x343434)
	end
	
	doTweenAlpha('thingToDisplayAlpha' .. dir, 'thingToDisplay' .. dir, 0, 0.425)
end
